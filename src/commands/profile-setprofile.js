...
if (!text) return conn.reply(m.chat, `ꕤ Debes especificar una descripción válida para tu perfil.\n\n> ✐ Ejemplo » *${usedPrefix + command} Hola, uso WhatsApp!*`, m)
user.description = text
return conn.reply(m.chat, `ꕤ Se ha establecido tu descripcion, puedes revisarla con /profile ฅ^•ﻌ•^ฅ`, m)
break
}
