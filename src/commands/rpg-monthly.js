var handler = async (m, { conn, usedPrefix }) => {
    ...
    if (now < user.lastmonthly) {
        ...
        return conn.reply(m.chat, `ꕤ Ya has reclamado tu recompensa mensual.\n> Puedes reclamarlo de nuevo en *${wait}*`, m)
    }
    ...
    conn.reply(m.chat, `「❁」 Has reclamado tu recompensa mensual de *+${coins.toLocaleString()} ${userCurrency}* (Mes *${user.monthlyStreak}*)\n${msg}`, m)
}
