...
if (!text) return conn.reply(m.chat, `ꕤ Por favor, ingrese el número al que quiere enviar una invitación al grupo.`, m)
...
const invite = `ꕤ 𝗜𝗡𝗩𝗜𝗧𝗔𝗖𝗜𝗢𝗡 𝗔 𝗨𝗡 𝗚𝗥𝗨𝗣𝗢\n\nꕥ *Usuario* » ${tag}\n✿ *Chat* » ${chatLabel}\n✰ *Fecha* » ${horario}\n✦ *Link* » ${link}`
await conn.reply(`${text}@s.whatsapp.net`, invite, m, { mentions: [m.sender] })
m.reply(`ꕤ El enlace de invitación fue enviado al usuario correctamente.`)
}
