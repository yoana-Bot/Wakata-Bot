...
const handler = async (m, { conn, command, usedPrefix, text }) => {
  ...
  try {
    switch (command) {
      ...
      case 'testwelcome': {
        // Obtener groupMetadata de la conexión
