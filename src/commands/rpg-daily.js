var handler = async (m, { conn, usedPrefix }) => {
    ...
    if (now < user.lastDaily) {
        ...
        return conn.reply(m.chat, `ꕤ Ya has reclamado tu *Daily* de hoy.\n> Puedes reclamarlo de nuevo en *${wait}*`, m)
    }
    ...
    conn.reply(m.chat, `「✿」Has reclamado tu recompensa diaria de *${reward.toLocaleString()} ${userCurrency}*! (Día *${user.streak}*)\n${msg}`, m)
}
